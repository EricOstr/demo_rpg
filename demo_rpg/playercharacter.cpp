...
const welltype PlayerCharacter::GetCurrentMP() const noexcept { (_player_class->MP) ? _player_class->MP->GetCurrent() : 0; }
const welltype PlayerCharacter::GetMaxMP() const noexcept { (_player_class->HP) ? _player_class->HP->GetMax(): 0; }
